...
def main():
    ...
    if args.input_file is not None:
        Interpreter(parser=args.parser).eval_from_file(args.input_file, print_input=args.print_input, print_tree=args.print_tree, commandline_args=args.command_line_args)
    else:
        Repl(parser=args.parser).cmdloop()
    return 0
